---
name: sdd-design
description: Create technical design from proposal and specs, then route to mandatory security design
...
Follow that skill as the source of truth. For new changes, do not require `security-applicability.md`; route successful design to mandatory `sdd-security-design`.
