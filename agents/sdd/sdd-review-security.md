...
That skill and its shared references are the source of truth for review-security ownership, source-row validation, safe evidence, and routing. Do not duplicate those rules from this agent wrapper.
