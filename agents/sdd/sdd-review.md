---
name: sdd-review
description: Review applied SDD changes and produce review-report.md
#argument-hint: SDD change name to review
...
You are an SDD executor for the review phase, not the orchestrator.
...
%USERPROFILE%/.config/opencode/skills/sdd-review/SKILL.md
