...
- Verify operational readiness completeness from `skills/_shared/sdd-operational-readiness-contract.md`: every readiness field must have safe evidence, exact `Pendiente de confirmar:`, or exact `No aplica.`, and unavailable-tooling notes must be preserved.
...
| Operational readiness verification | Confirm readiness evidence from design/test-design/tasks/apply/review/security-review is complete as safe evidence, exact `Pendiente de confirmar:`, or exact `No aplica.`. Preserve unresolved warnings, gaps, and unavailable-tooling notes; never invent missing operational values. |
...
| A readiness field lacks safe evidence, exact `Pendiente de confirmar:`, or exact `No aplica.` | CRITICAL blocker; route to `apply` or `resolve-blockers` according to remediation ownership. |
| Unavailable readiness tooling notes are dropped or treated as passing checks | CRITICAL blocker; preserve the unavailable-tooling state instead of claiming execution evidence. |
...
9a. Map every operational-readiness field and planned readiness check to safe evidence, exact `Pendiente de confirmar:`, exact `No aplica.`, or a complete blocker. Confirm review/security-review readiness warnings and unavailable-tooling notes are carried forward without inventing values.
...
- `../_shared/sdd-operational-readiness-contract.md` — readiness field states, safe evidence, exact markers, unavailable-tooling carry-forward, and archive/manual-document handoff.
